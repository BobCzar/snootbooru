<div class='content-wrapper' id='user-registration'>
    ...
    <div class='info'>
        ...
        <hr/>
        <p>Newly created accounts will start with restricted permissions. Commenting and likes/dislikes will be available after three days. Full access will be granted after an additional 3-12 days based on activity.
